...
Structures of file should consists of 10 lines of 0 or 1 to indicate cell state
*/
...
Return if you updated cells or not to break out while loop from main.
*/
